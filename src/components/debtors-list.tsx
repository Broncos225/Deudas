...
import { User, Mail, Phone, MoreHorizontal, Edit, Trash2, Building } from "lucide-react";
...
export function DebtorDetails({ debtors, onAddDebtor, onEditDebtor, onDeleteDebtor }: DebtorDetailsProps) {
  return (
    <Card className="mt-4">
